...
# 
# The Pearson correlation coefficient is a [descriptive statistic](https://www.scribbr.com/statistics/descriptive-statistics/), meaning that it summarizes the characteristics of a dataset. Specifically, it describes the strength and direction of the linear relationship between two quantitative variables.
